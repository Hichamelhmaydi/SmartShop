...
/**
 * Centralizes exception handling as required by brief: "La classe
 * @ControllerAdvice centralise la gestion des exceptions"
 */
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    /**
     * Builds error response matching brief requirements: "timestamp, code HTTP,
     * type d'erreur, message explicatif, et le chemin de la requête"
     */
