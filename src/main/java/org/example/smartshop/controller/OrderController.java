...
/**
 * Order management endpoints PDF Section 4: "Gestion des Commandes"
 */
@RestController
...
public class OrderController {
    ...
    /**
     * POST /api/orders PDF: "Créer une commande multi-produits avec quantités"
    ...
    /**
     * GET /api/orders/{id} Access: ADMIN (all orders) or CLIENT (only own
     * orders)
     */
    @GetMapping("/{id}")
    ...
    /**
     * GET /api/orders Access: ADMIN only
     */
    @GetMapping
    ...
    /**
     * PUT /api/orders/{id}/confirm PDF: "PENDING → CONFIRMED: validation par
     * ADMIN (après paiement complet)" Access: ADMIN only
     */
    ...
    /**
     * PUT /api/orders/{id}/cancel PDF: "PENDING → CANCELED: annulation par
