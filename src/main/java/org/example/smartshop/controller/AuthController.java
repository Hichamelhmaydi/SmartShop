...
/**
 * Authentication endpoints PDF: "Authentification par HTTP Session
 * (login/logout)"
 */
@RestController
...
public class AuthController {
    ...
    /**
     * POST /api/auth/login PDF: "login/logout"
     */
    @PostMapping("/login")
    ...
    /**
     * POST /api/auth/logout PDF: "login/logout"
     */
    @PostMapping("/logout")
    ...
    /**
     * GET /api/auth/me Gets current logged-in user info
     */
    @GetMapping("/me")
