...
import org.example.smartshop.service.ClientService;
import org.example.smartshop.service.OrderService;
...
/**
 * Client management endpoints PDF Section 1: "Gestion des Clients"
 */
@RestController
...
public class ClientController {
    ...
    /**
     * POST /api/clients PDF: "Créer un client" Access: ADMIN only
     */
    @PostMapping
    ...
    /**
     * GET /api/clients/{id} PDF: "Consulter les informations d'un client"
    ...
    /**
     * GET /api/clients PDF: "Voir tous les clients" Access: ADMIN only
     */
    @GetMapping
    ...
    /**
     * PUT /api/clients/{id} PDF: "Mettre à jour les données d'un client"
     * Access: ADMIN only
     */
    @PutMapping("/{id}")
    ...
    /**
     * DELETE /api/clients/{id} PDF: "Suppression d'un client" Access: ADMIN
     * only
     */
    @DeleteMapping("/{id}")
    ...
    /**
     * GET /api/clients/{id}/orders PDF: "Consulter l'historique des commandes"
