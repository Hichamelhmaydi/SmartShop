...
/**
 * Payment management endpoints PDF Section 5: "Système de Paiements
 * Multi-Moyens"
 */
@RestController
@RequestMapping("/api")
...
public class PaymentController {
    ...
    /**
     * POST /api/orders/{orderId}/payments PDF: "Une commande peut être payée en
     * plusieurs fois" Access: ADMIN only
     */
    ...
    /**
     * GET /api/orders/{orderId}/payments PDF: Get all payments for an order
    ...
    /**
     * PUT /api/payments/{id}/status PDF: "Statuts possibles: En attente /
     * Encaissé / Rejeté" Access: ADMIN only
     */
    ...
    /**
     * GET /api/payments/pending Access: ADMIN only
     */
    ...
    /**
     * GET /api/payments/{id} Access: ADMIN only
     */
