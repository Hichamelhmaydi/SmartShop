...
/**
 * Product management endpoints PDF Section 3: "Gestion des Produits"
 */
@RestController
...
public class ProductController {
    ...
    /**
     * POST /api/products PDF: "Ajouter des produits" Access: ADMIN only
     */
    @PostMapping
    ...
    /**
     * GET /api/products/{id} PDF: "Consulter la liste des produits" Access: All
     * authenticated users
     */
    @GetMapping("/{id}")
    ...
    /**
     * GET /api/products PDF: "Consulter la liste des produits avec filtres et
     * pagination" Access: All authenticated users (CLIENT: lecture seule)
     */
    @GetMapping
    ...
    /**
     * PUT /api/products/{id} PDF: "Modifier les informations produits" Access:
     * ADMIN only
     */
    @PutMapping("/{id}")
    ...
    /**
     * DELETE /api/products/{id} PDF: "Supprimer des produits (soft delete)"
     * Access: ADMIN only
     */
    @DeleteMapping("/{id}")
